...
#	set(HPMPC_TARGET C99_4X4)
	set(HPMPC_TARGET CORTEX_A9)
endif()

if(NOT DEFINED USE_BLASFEO)
#	set(HPMPC_USE_BLASFEO 1)
	set(HPMPC_USE_BLASFEO 0)
endif()
...
ExternalProject_Add(
    ...
    BUILD_IN_SOURCE 1
    BUILD_COMMAND make clean static_library -j 2 TARGET=${HPMPC_TARGET} BLASFEO_PATH=${HPMPC_BLASFEO_PATH} USE_BLASFEO=${HPMPC_USE_BLASFEO}
