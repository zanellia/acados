...
# ocp.solver_options.integrator_type = 'LIFTED_IRK'
# ocp.solver_options.integrator_type = 'ERK'
ocp.solver_options.sim_method_num_stages = 1  # 1: RK1, 2: RK2, 4: RK4    
ocp.solver_options.sim_method_num_steps = 1  # 1: RK1, 2: RK2, 4: RK4    
ocp.solver_options.sim_method_newton_iter = 1  # 1: RK1, 2: RK2, 4: RK4    
...
for i in range(Nsim):
    ...
    # if i > Nsim/2 :
    #     acados_solver.set(0, "p", nmp.array([w_val, 0.0, 0.0, 0.5*tau_wal]))
    #     acados_solver.set(1, "p", nmp.array([w_val, 0.0, 0.0, 0.5*tau_wal]))
