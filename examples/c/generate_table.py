...
print('')
print('---------------------------------------------------------------')
print('Parsing log file for NN = {0}, NM = {1}, NS = {2} and {3}-RTI scheme'.format(NN, NM, NS, RTI))
print('---------------------------------------------------------------')
# import logged data
if RTI == 0:
    OFFLINE_COND = 1
...
print('')
print('max CPU time = {0}, avg CPU time = {1}, max iters = {2}, closed-loop cost = {3}'.format(max_CPU, avg_CPU, max_iters, closed_loop_cost))
print('')
